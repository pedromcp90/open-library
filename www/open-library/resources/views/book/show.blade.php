            ...
            <div class="flex-column h-100 border border-2 p-2 col-12 col-md-auto text-center">
                <div class="row">
                    <div class="col">
                        ...
                        @else
                            <img class="rounded" width="200px" src="{{ Helper::parseImageUri($book->cover_image) }}"
                                alt="Book cover">
            ...
            <div class="col-12 col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <a href="/author/{{ $author->id }}" class="author-link align-middle">{{ $author->first_name }} {{ $author->last_name }}</a>
                        {{ !$loop->last ? ',' : '' }}
                        @endforeach
                    </div>
                    <div class="col-12">
                        <span class="font-weight-bold written-by align-middle">Publisher:</span>
                        <a href="/publisher/{{ $publisher->id}}" class="author-link align-middle">{{ $publisher->name }}</a>
                    </div>
                        ...
                        <div class="avatar-group">
                            @foreach ($book->authors as $author)
                                <a href="/author/{{ $author->id }}" class="avatar avatar-md rounded-circle"
                                    ...
                                    @else
                                        <img class="rounded"
                                            src="{{ Helper::parseImageUri($author->author_image) }}" alt="Book cover">
